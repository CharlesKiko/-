        ...
        <el-upload ref="uploadImageRef" action="http://localhost:8080/upload/image" list-type="picture-card"
          ...
          <template #tip>
            <div style="font-size: 12px;color: #919191;">
              <span>请上传大小不超过</span>&nbsp
              <span style="color: red;">5MB</span>&nbsp
              <span>格式为</span>&nbsp
              <span style="color: red;">png/jpg/jpeg</span>&nbsp
              <span>的图片</span>
            </div>
          </template>
        </el-upload>
      ...
      <el-form-item label="上传视频">
        <el-upload ref="uploadVideoRef" class="avatar-uploader el-upload--text" :drag="plus"
          ...
          <div class="el-upload__tip" slot="tip">
            <span>请上传大小不超过</span>&nbsp
            <span style="color: red;">100MB</span>&nbsp
            <span>格式为</span>&nbsp
            <span style="color: red;">mp4</span>&nbsp
            <span>的文件</span>
          </div>
        </el-upload>
      </el-form-item>
